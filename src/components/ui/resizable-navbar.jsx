      ...
      {items.map((item, idx) => (
        ...
        >
          {hovered === idx && (
            <motion.div
              layoutId="hovered"
              className="absolute inset-0 h-full w-full rounded-full bg-blue-100 dark:bg-gray-800"
            />
          )}
...
export const MobileNavToggle = ({ isOpen, onClick }) => {
  return (
    <button
      ...
      className="p-1 rounded-md text-black dark:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
    >
