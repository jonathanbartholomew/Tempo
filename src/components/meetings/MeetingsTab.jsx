...
export default function MeetingsTab({ meetings, jobs, onAddMeeting, onDeleteMeeting, onToggleMeeting, timeFormat }) {
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        {upcoming.length === 0 ? (
          ...
          <div className="space-y-2">
            {upcoming.map((m) => (
              <MeetingCard key={m.id} meeting={m} job={getJob(jobs, m.jobId)} onDelete={onDeleteMeeting} onToggle={onToggleMeeting} timeFormat={timeFormat} />
            ))}
          </div>
        )}
      </div>
